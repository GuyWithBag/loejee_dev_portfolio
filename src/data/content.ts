...
export const BIO = {
  ...
  philosophy: "Code is a tool for creativity. I believe in building software that doesn't just work, but feels right to the user.",
  about: [
  ...
  approach: "Iterative growth, clean architecture, and empathy for the user. I believe in software that solves real problems."
};
